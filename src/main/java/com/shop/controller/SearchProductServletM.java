...
@WebServlet("/searchProductM.do")
public class SearchProductServletM extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("manager/product/productList.jsp").forward(request, response);
	}
